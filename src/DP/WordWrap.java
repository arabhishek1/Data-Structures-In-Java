...
/**
 * Created by abhishek.ar on 25/08/17.
 ...
 1) There are 3 lines. One line has 3 extra spaces and all other lines have 0 extra spaces. Total extra spaces =
 3 + 0 + 0 = 3. Total cost = 3*3*3 + 0*0*0 + 0*0*0 = 27.

 2) There are 3 lines. Each of the 3 lines has one extra space. Total extra spaces = 1 + 1 + 1 = 3. Total cost = 1*1*1
 + 1*1*1 + 1*1*1 = 3.
...
//        System.out.println(bytesToLong(Bytes"\x00\x00\x01_+\x99xX");
        String s = new String("abc");
        s = new String(s.concat("def"));
